...
// GRDB+SQLCipher: Using skiptools/swift-sqlcipher for Skip cross-platform support
dependencies.append(.package(url: "https://github.com/skiptools/swift-sqlcipher", from: "1.7.1"))
...
let package = Package(
    ...
    targets: [
        // GRDBSQLCipher shim is provided by swift-sqlcipher's grdb.h
        .target(
            name: "GRDB",
            dependencies: [
